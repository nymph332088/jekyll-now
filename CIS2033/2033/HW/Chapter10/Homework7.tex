...
\title{Homework based on Chapter 10\\
...
\subparagraph*{c.} Calculate the $\rho(X,Y)$. Are they correlated or not correlated?
...
\subparagraph*{f.} Calculate $Cov(X, Y)$ and $\rho(X,Y)$. Are they correlated or not correlated?
